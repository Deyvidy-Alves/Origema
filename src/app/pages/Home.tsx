...
export default function Home() {
  ...
  return (
    <>
      {/* Banner Principal com Fundo Overlay */}
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden bg-secondary/30">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl mb-6 text-foreground">Design que respeita origens</h1>
      ...
      <section className="py-20 bg-secondary/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl mb-4 text-foreground">Nossos Produtos</h2>
            ...
            {products.map((product) => (
              <div key={product.id} className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow group border border-secondary/30 flex flex-col h-full">
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <h3 className="text-xl mb-2 text-foreground font-bold">{product.name}</h3>
                  <p className="text-2xl text-primary mb-4 font-semibold">{product.price}</p>
                  
                  {/* mt-auto joga o botão para o final do card, mantendo o alinhamento visual */}
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl mb-6 text-foreground">Nossa Essência</h2>
              ...
              <Button asChild className="mt-8 bg-primary hover:bg-primary/90 px-8 py-6 text-white">
      ...
      <section className="py-20 bg-primary text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl mb-6">Vamos criar juntos?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild className="bg-secondary text-foreground hover:bg-secondary/80 px-8 py-6 text-lg font-bold transition-all shadow-md">
